...
#define AI_MODEL_IN_1_CHANNEL     (20)
#define AI_MODEL_IN_1_HEIGHT      (20)
#define AI_MODEL_IN_1_WIDTH       (6)
#define AI_MODEL_IN_1_SIZE        (20 * 20 * 6)
#define AI_MODEL_IN_1_SIZE_BYTES  (9600)
